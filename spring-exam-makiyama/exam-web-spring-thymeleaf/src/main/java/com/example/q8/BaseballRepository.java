...
public class BaseballRepository {
	...
	public BaseballDomain load(Integer id) {
		String sql = "SELECT id,name,established_date FROM teams WHERE id = :id";
		SqlParameterSource param = new MapSqlParameterSource().addValue("id", id);
		BaseballDomain baseballDomain = template.queryForObject(sql, param, baseballDomainRowMapper);
